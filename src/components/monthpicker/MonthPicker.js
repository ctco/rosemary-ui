...
class MonthPicker extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            value: props.value ? dateUtils.parse(props.value, props.format) : dateUtils.getFirstDayOfMonth(dateUtils.getToday()),
            open: false
        };
    ...
    render() {
        return (
            <Popup popupClassName="popover-colored"
                   ...
                   onTransitionClosedToOpen={() => {this.resetYear();}}>
                {
                    this.getTarget()
                }
                <MonthPickerPopup year={this.state.year}
