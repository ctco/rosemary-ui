        ...
        return (
            <div tabIndex="-1">
                <div className="month-picker-popup__header">
                    ...
                    <Select className="month-picker-popup__years select--sm"
                ...
                <MonthPickerCalendar onSelected={this.props.onSelected}
                                     year={this.state.year}
                                     minDate={this.props.minDate}
                                     maxDate={this.props.maxDate}
                                     getStyles={this.props.getStyles}/>
                <Button onClick={() => this.props.onSelected(dateUtils.getFirstDayOfMonth(dateUtils.getToday()))}
                        className="month-picker-popup__today-link btn-link btn--sm">Current month</Button>
            </div>
        );
    }
}
