...
class MonthView extends React.Component {
    ...
    renderWeek(week, weekIdx, content) {
        ...
        return (
            <div key={'week_' + weekIdx} className="rbc-month-row" ref={!weekIdx && (r => (this._firstRow = r))}>
                {this.renderBackground(week, weekIdx)}
                <div className="rbc-row-content">
                    <div className="rbc-row" ref={!weekIdx && (r => (this._firstDateRow = r))}>
    ...
    renderBackground(row, idx) {
        ...
        function highlight(cell) {
            ...
            return (
                (hoveredDate && startDate && date && isDateBetween(startDate, hoveredDate, date, '()')) ||
    ...
    _showMore(segments, date, weekIdx, slot) {
        ...
        let events = segments.filter(seg => isSegmentInSlot(seg, slot)).map(seg => seg.event);
