...
class TimeGrid extends Component {
            ...
            <div ref="headerCell" className={cn('rbc-time-header', isOverflowing && 'rbc-overflowing')} style={style}>
                ...
                <div className="rbc-row">
                    ...
                    <div ref="allDay" className="rbc-allday-cell">
                        ...
                        />
                        <div style={{ zIndex: 1, position: 'relative' }}>{this.renderAllDayEvents(range, levels)}</div>
                    </div>
                </div>
            </div>
        );
    ...
    renderHeaderCells(range) {
        ...
        return range.map((date, i) => (
            <div key={i} className="rbc-header" style={segStyle(1, this._slots)}>
...
TimeGrid.propTypes = PROPERTY_TYPES;
TimeGrid.defaultProps = DEFAULT_PROPS;
