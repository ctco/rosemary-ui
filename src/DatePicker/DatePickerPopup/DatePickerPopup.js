        ...
        return (
            <div tabIndex="-1">
                <div className="date-picker-popup__header">
                    ...
                    />
                    <Select
                        className="date-picker-popup__months select--sm"
                    ...
                    />
                    <Select
                        className="date-picker-popup__years select--sm"
                ...
                />
                <Button
                    onClick={() => this.props.onSelected(getToday())}
                    className="date-picker__today-link btn-link btn--sm"
                >
                    Today
                </Button>
            </div>
